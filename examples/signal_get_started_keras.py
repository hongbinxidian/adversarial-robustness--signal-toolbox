...
parser.add_argument('-m', '--attack_model', default='FastGradientMethod',
...
(mods, snrs, lbl), (X_train, Y_train), (X_test, Y_test), (train_idx, test_idx), (min_pixel_value, max_pixel_value) = load_data_snrs(
        '/media/xd2/Signal/mhb/xdaima-AdvBox-master/AdvBox/data/RML2016.10a_dict.pkl', [i for i in range(snr_define, 20, 2)], train_rate=0.9)
